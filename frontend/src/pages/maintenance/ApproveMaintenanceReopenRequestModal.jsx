...
const getErrorMessage = error =>
    ...
    error?.message ||
    "Unable to approve maintenance reopening request.";

function ApproveMaintenanceReopenRequestModal({
    open,
    maintenanceRequest,
    accessContext,
    onClose,
    ...
    const submit =
        async event => {
            ...
            if (!pendingReopen) {
                setError(
                    "Load the pending reopening request before approval."
                );
                return;
            }
            ...
            if (
                ...
                setError(
                    "Approval decision note must contain between 5 and 2000 characters."
                );
                return;
            }
        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-slate-950/60 p-3 sm:p-6">
            ...
            >
                <div className="flex shrink-0 items-start justify-between gap-4 border-b border-slate-200 px-5 py-4 sm:px-6">
                    ...
                    <button
                        type="button"
                        aria-label="Close approve reopening request modal"
                        disabled={submitting}
                        onClick={onClose}
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-800">
                            <div className="flex items-start justify-between gap-3">
                                ...
                                <button
                                    ...
                                    className="inline-flex shrink-0 items-center gap-1.5 rounded-xl border border-blue-200 bg-white px-3 py-2 text-xs font-semibold text-blue-800 transition hover:bg-blue-100 disabled:cursor-not-allowed disabled:opacity-50"
                                >
                        ...
                        <label className="block">
                            ...
                            <textarea
                                ...
                                maxLength={2000}
                                rows={6}
                                placeholder="Explain why this maintenance request should be reopened..."
                                onChange={
                                    event => {
                                        setDecisionNote(
                                            event.target.value
                        ...
                        <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-xs leading-5 text-slate-600">
                            Approval moves the maintenance request back to the reopening target recorded by the backend workflow.
                        </div>
                    </div>
                </div>
...
export default ApproveMaintenanceReopenRequestModal;
