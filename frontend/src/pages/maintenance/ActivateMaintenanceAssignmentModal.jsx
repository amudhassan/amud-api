...
const getErrorMessage = error =>
    ...
    error?.message ||
    "Unable to activate maintenance assignment.";
...
function ActivateMaintenanceAssignmentModal({
    open,
    ...
    const submit =
        async event => {
            ...
            if (
                ...
                setError(
                    "Refresh the assignment before activation."
                );
                return;
            }
            ...
            if (
                ...
                setError(
                    `Assignment cannot be activated from ${formatLabel(
                        authoritativeAssignment
                            .status
                    )}.`
                );
            ...
            if (
                ...
                setError(
                    "Activation reason must contain between 3 and 2000 characters."
                );
                return;
            }
        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-slate-950/60 p-3 sm:p-6">
            ...
            >
                <div className="flex shrink-0 items-start justify-between gap-4 border-b border-slate-200 px-5 py-4 sm:px-6">
                    ...
                    <button
                        type="button"
                        aria-label="Close activate assignment"
                        disabled={submitting}
                        onClick={onClose}
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="rounded-2xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-800">
                            <p className="font-semibold">
                                Activation starts operational work
                            </p>

                            <p className="mt-1 text-xs leading-5">
                                The frontend first reloads the assignment so the latest status and updated-at timestamp are used for concurrency protection.
                            </p>
                        </div>
                        ...
                        <label className="block">
                            ...
                            <textarea
                                ...
                                maxLength={2000}
                                rows={5}
                                placeholder="Explain why the assignment is ready to start..."
                                onChange={
                                    event => {
                                        setReason(
                                            event
...
export default ActivateMaintenanceAssignmentModal;
