...
function TerminateLeaseModal({
    ...
    const submit = async event => {
        ...
        if (
            terminationReason.length < 5 ||
            terminationReason.length > 2000
        ) {
            setError(
        ...
        try {
            ...
            const response =
                await apiClient.patch(
                    `/leases/${leaseDetail.public_id}/terminate`,
                    {
                        termination_reason:
                            terminationReason
                    }
            ...
            >
                ...
                >
                    <div
                        ...
                        "
                    >
                        Termination is a lifecycle action for
                        Active leases only. The backend remains
                        authoritative for permissions, lease
                        integrity and the final unit status.
                    </div>
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                <label
                                    htmlFor="lease_termination_reason"
                                ...
                                <textarea
                                    ...
                                    placeholder="Explain why this active lease is being terminated."
                                    className="
                                        w-full resize-y
                                        rounded-xl
                                        border border-slate-200
                            ...
                            <div
                                ...
                                "
                            >
                                Terminating an active lease may
                                release its occupied unit. The
                                backend will recalculate whether
                                the unit should remain occupied,
                                become reserved, or become
                                available.
                            </div>
                        </div>
                    ) : null}
