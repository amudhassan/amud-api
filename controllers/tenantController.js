        ...
        async (req, res, next) => {
            ...
            try {
                ...
                if (
                    ...
                    return next(
                        new AppError(
                            `A tenant with status '${result.current_status}' cannot be blocked directly. Activate the tenant first.`,
                            409
                        )
                    );
                }
                ...
                if (error.code === "23514") {
                    return next(
                        new AppError(
                            "Tenant blocking violates a tenant or owner relationship integrity rule.",
                            422
                        )
                    );
                }
